    ...
    <AuthenticatedLayout>
        ...
        <div class="py-8">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <!-- Empty state -->
                <div v-if="universes.length === 0" class="text-center py-16">
                    <DCard variant="outlined" padding="lg">
                        <div class="flex flex-col items-center gap-4">
                            ...
                            <h3 class="text-xl font-nunito font-bold text-text-primary">
                                No universes yet
                            </h3>
                            <p class="text-text-secondary max-w-sm">
                                Create your first universe to start building your branching narrative!
                            </p>
                            <DButton @click="showCreateModal = true">
